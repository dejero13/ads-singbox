...
**Последнее обновление:** 17.04.2026 06:06 UTC
...
[geosite-category-ads-all.srs](https://github.com/dejero13/ads-singbox/releases/download/latest/geosite-category-ads-all.srs)

### Как использовать в sing-box:
```json
{
  "route": {
    "rule_set": [
